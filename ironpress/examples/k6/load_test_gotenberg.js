...
<body>
  ...
  <p>This is a lightweight document converted during concurrent load testing of Gotenberg Chromium.</p>
...
export default function () {
  const url = 'http://localhost:3000/forms/chromium/convert/html';

  const data = {
    files: http.file(htmlData, 'index.html', 'text/html'),
  };
