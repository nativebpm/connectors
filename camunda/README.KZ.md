...
### Dbmate көмегімен деректер базасын орнату
Docker әдепкі конфигурацияларын өзгертпей, CDC репликация слоттары мен жарияланым схемаларын қауіпсіз қосу үшін біз [Dbmate](https://github.com/amacneil/dbmate) құралын пайдаланамыз.

Миграциялар репликацияны конфигурацияламас бұрын Camunda схема кестелерінің инициализациялануын күтетін (`psql` арқылы стандартты тексеруді қолданатын) `amacneil/dbmate:2.15.0` іске қосу контейнері арқылы автоматты түрде қолданылады:
