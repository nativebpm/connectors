...
| **CDC-2000** | 80 | Sequin CDC (REST) | 2000 | 8000 (8038) | 82.41 s | **24.27 /s** | **97.54 /s** | 0 | **Success**. Highly stable throughput. Outperforming REST polling under heavy load by eliminating thread/connection lock storms. |
